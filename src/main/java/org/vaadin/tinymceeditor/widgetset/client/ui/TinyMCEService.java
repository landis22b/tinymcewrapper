        ...
        var conf = {
            ...
            setup: function (ed) {
                ...
                ed.on('selectionChange', function (e) {
                    var statusObj = {
                        collapsed: ed.selection.getRng().collapsed,
                        startOffset: ed.selection.getRng().startOffset,
                        endOffset: ed.selection.getRng().endOffset
                    };
                    parent.tinyMCESelectionChange(statusObj);
                });
